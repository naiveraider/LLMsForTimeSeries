...
parser = argparse.ArgumentParser(description='NLinear')
...
parser.add_argument('--model', type=str, default='NLinear')
...
for ii in range(args.itr):
    ...
    setting = '{}_sl{}_ll{}_pl{}_itr{}'.format(args.model_id, args.seq_len, args.label_len, args.pred_len, ii)
