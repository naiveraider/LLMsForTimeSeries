...
for ii in range(args.itr):
    ...
    setting = '{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_itr{}'.format(args.model_id, args.seq_len, args.label_len, args.pred_len,
    ...
    if args.model == 'PatchTST':
        ...
        # Create a wrapper to handle input/output format conversion
